...
useHead({
  ...
  meta: [
    ...
    { property: "og:description", content: `Alle voetbal uitslagen van de Koninklijke Algemene Vereniging van Vriendenclubs Antwerpen, Oost-Vlaanderen en Vlaams-Brabant. Vind hier de wedstrijden en uitslagen van ${route?.query?.team}.` },
    { property: "og:type", content: "website" },
    { property: "og:url", content: `https://kavvv-uitslagen.be/club?team=${route?.query?.team}` },
    { property: "og:locale", content: "nl_Be" },
    { property: "og:image", content: "https://kavvv-uitslagen.be/mstile-144x144.png" },
  ],
  htmlAttrs: { lang: "nl" },
  link: [{ rel: "canonical", href: `https://kavvv-uitslagen.be/club?team=${route?.query?.team}` }],
  link: [
...
games.value = data?.value?.matches?.sort((a, b) => new Date(a.date) - new Date(b.date));
